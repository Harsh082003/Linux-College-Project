...
- File Organizer (categorize files into folders)
- Backup & Restore (tar.gz)
- Log Analyzer (journalctl or syslog)
- Process Manager (view top processes and kill by PID)
- Disk Cleanup (package cleanup + large file listing)
